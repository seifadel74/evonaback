...
return [
    ...
    'title' => 'Evona API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'Evona API for managing products, categories, cart, orders, wishlist, reviews, and admin operations. Sanctum token-based authentication.',
    ...
    'auth' => [
        ...
        'placeholder' => '{your-santum-token}',

        // Any extra authentication-related info for your users. Markdown and HTML are supported.
        'extra_info' => 'You can retrieve your token by logging in via <code>POST /api/v1/auth/login</code> and using the <code>token</code> from the response.',
    ],
